...
What it demonstrates:
  ...
  - The verifier re-derives the representative output (total embodied carbon)
    ...
    scalar_epsilon comparator. No subprocess, no bundle-supplied code.
...
def _load_legacy_build():
    _s = _ilu.spec_from_file_location("dc_emissions_mrv__legacy_build_bundle", _HERE / "_build_bundle.py")
