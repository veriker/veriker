...
WHY SYNTHETIC (not the real captured staging bundle):
    The PUBLIC release (github.com/nexiverify/veriker) signs releases from the PUBLIC repo,
    so the C18 cosign cert-identity the OSS test asserts must name the PUBLIC workflow. A real
    captured Sigstore-STAGING cert bakes its SAN (github.com/nexiverify/...) into SIGNED DER
