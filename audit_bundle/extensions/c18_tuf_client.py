...
def _fetch_plugin_allowlist_impl(
    ...
    *,
    ...
    if registry_allowlist != ["ghcr.io/nexiverify/"]:
        raise TUFRoleSeparationViolation(
            f"plugin-allowlist registry_org_allowlist = {registry_allowlist!r}; "
            "expected exactly ['ghcr.io/nexiverify/']. Cross-registry plugin "
...
def fetch_plugin_allowlist(
    ...
    Defensive checks:
      - registry_org_allowlist contains exactly `ghcr.io/nexiverify/`
